            ...
            <tbody>
              @foreach($items as $item)
                <tr>
                  ...
                  <td>
                    <div>
                      <a href="{{ action('User\HowtoController@edit', ['id' => $item->id]) }}">編集</a><br/>
                      {{--<a href="{{ action('User\HowtoController@delete', ['id' => $item->id]) }}">削除</a>--}}
                      @php Utl::confirmATag('', 'delItem', action('User\HowtoController@delete', ['id' => $item->id]), '削除') @endphp
                    </div>
                  </td>
                </tr>
              @endforeach
