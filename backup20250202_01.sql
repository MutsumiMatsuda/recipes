...
SELECT pg_catalog.setval('public.l_trans_qs_id_seq', 45, true);
...
SELECT pg_catalog.setval('public.menus_id_seq', 62, true);
...
SELECT pg_catalog.setval('public.nutrient_materials_id_seq', 479, true);
...
SELECT pg_catalog.setval('public.nutrients_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.recipe_materials_id_seq', 5309, true);
...
SELECT pg_catalog.setval('public.recipes_id_seq', 222, true);
...
SELECT pg_catalog.setval('public.seasonings_id_seq', 925, true);
